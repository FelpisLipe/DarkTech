...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeServer(), new LootTableProvider(packOutput, Collections.emptySet(),
                List.of(new LootTableProvider.SubProviderEntry(DTBlockLootTableProvider::new, LootContextParamSets.BLOCK)/*,
                        new LootTableProvider.SubProviderEntry(ModEntityLootTableProvider::new, LootContextParamSets.ENTITY)*/), lookupProvider));
        generator.addProvider(event.includeServer(), new DTRecipeProvider(packOutput, lookupProvider));
